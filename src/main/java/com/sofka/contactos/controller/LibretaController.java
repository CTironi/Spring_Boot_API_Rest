...
public class LibretaController {
    ...
    /**
     * Devuelve el listado de contactos y sus teléfonos basados en un dato a buscar por nombre y/o apellidos
     *
    ...
    /**
     * Administrador para las excepciones a nivel SQL con respecto al manejo del acceso a los datos
     *
